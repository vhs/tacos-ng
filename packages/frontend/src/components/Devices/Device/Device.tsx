...
const Device: FC = () => {
    ...
    return (
        <div className='bg-gray-400 max-w-[265px] h-[268px] rounded-xl px-4 pb-4 pt-2 m-3'>
            <div className='text-2xl font-semibold font-cutive'>Lazer Cutter</div>
            <DeviceDescription />
            ...
            <div className='flex justify-between'>
                <button
                    className='bg-red-500 px-2 py-1 font-cutive font-semibold
                              rounded-[4px]'
                >
                    Delete
                </button>
                <button
                    className='bg-cyan-500 px-2 py-1 font-cutive font-semibold
                              rounded-[4px]'
                >
                    Arm
                </button>
